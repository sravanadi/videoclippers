...
export const SHORTENING_MODE_INSTRUCTIONS = {
  ...
  gaming:
    "Analyze the gameplay transcript for high-energy combat, clutch plays, and boss fights. Extract multiple non-overlapping clips strictly greater than 1 minute (61 to 179 seconds long) suitable for YouTube Shorts and vertical gaming montages.",
};
